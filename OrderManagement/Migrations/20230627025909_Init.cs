        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeFlavorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Product_TypeFlavor_TypeFlavorId",
                        column: x => x.TypeFlavorId,
                        principalTable: "TypeFlavor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
